...
function App() {
  ...
  const handleAction = async () => {
    const url =
      mode === "signup"
        ? "http://localhost:8000/signup" // Signup microservice
        : "http://localhost:8001/signin"; // Signin microservice
...
const styles = {
  ...
  toggleButton: { padding: "10px 20px", marginTop: "10px", backgroundColor: "#6c757d", color: "#fff" },
